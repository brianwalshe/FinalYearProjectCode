...
//
///**
// * Created by brian on 24/03/2019.
// */
//
...
////            : WeightActivity(itemView) {
////        var weightView:View itemView;
////        TextView = itemView.findViewById(R.id.weight_view);
...
//
//
//public class WeightActivity : AppCompatActivity() {
//
//        override fun onCreate(savedInstanceState: Bundle?) {
//        super.onCreate(savedInstanceState)
